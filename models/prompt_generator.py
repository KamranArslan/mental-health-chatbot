    ...
    def __init__(self):
        self.emotion_prompts = {
            "anger": (
                ...
                "👉 A helpful technique might be to take a few deep breaths or write down what's making you upset. "
                "Would you like to try that?"
            ),
            "disgust": (
                "I sense that you're feeling disgusted. This can be a challenging emotion to deal with. "
            ...
            "fear": (
                ...
                "This can calm anxiety. Would you like me to guide you through this?"
            ),
            "happiness": (
